...
fitting_parameter_bounds = {
    ...
    "kOCPdeactivation": (1e-10, None), # manually fit
    "OCPmax": (1e-10, None), # manually fit
    "vNQ_max": (1e-10, None), # manually fit
    "KMNQ_Qox": (1e-10, None), # manually fit
    "KMNQ_Fdred": (1e-10, None), # manually fit
}
