...
label_figure(sfig2, pos=(0.0,1.01), label="A")
label_figure(sfig2, pos=(0.2,1.01), label="B")
label_figure(sfig2, pos=(0.4,1.01), label="C")
label_figure(sfig2, pos=(0.6,1.01), label="D")
label_figure(sfig2, pos=(0.8,1.01), label="E")
...
label_figure(sfig4, pos="top right", label="H")
